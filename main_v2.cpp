...
#define on 104      // activate propeller servo degrees
...
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#define stepTime 900     // stepDELAYVAL
#define turnTime 2600    // turnDELAYVAL
...
void loop() {
  ...
  if (btt >= 1) {  // if button pressed, START
    ...
    //..................................................................
    // obstacle
    // swithed to "CHEAT MODE"
    if ((digitalRead(mode) == LOW) and (digitalRead(ultrasonic) == LOW)) {
      for (int i = 0; i < 150; i++) {
        goFwdSlow();

        if ((analogRead(A5) line lineV) or  // switch to "CHEAT MODE"
    ...
    // obstacle
    // "NORMAL MODE"
    if ((digitalRead(ultrasonic) == LOW) and ((digitalRead(five) == HIGH) and (digitalRead(seven) == HIGH) and (digitalRead(eight) == HIGH) and (digitalRead(three) == HIGH) and  // switched to normal mode
    ...
    // line Left
    if (((analogRead(A1) line lineV) or (analogRead(A5) line lineV)) and (analogRead(backup) > backupLight) and (analogRead(backup2) > backupLight2) and (digitalRead(seven) == HIGH)) {
      motorStop();
      delay(100);
      /*
      for ( int i = 0 ; i < 9 ; i ++) {
      ...
      for (int i = 0; i < 500; i ++) {
        ...
        if (((analogRead(backup) < backupLight) or
             (analogRead(backup2) < backupLight2) or
             (digitalRead(seven) == LOW)) and
            ((analogRead(A5) line lineV) or
             (analogRead(A5) line lineV) or
             (analogRead(A5) line lineV) or
             (analogRead(A5) line lineV))) {
          motorStop();
    ...
    if ((((analogRead(A5) line lineV) or (analogRead(A1) line lineV)) and (analogRead(A3) line lineV)) and (analogRead(A3) line lineV) and (analogRead(backup) > backupLight) and (analogRead(backup2) > backupLight2) and  // front left and rear right line
        (digitalRead(seven) == HIGH)) {
      goFwd();
    }
    ...
    if ((((analogRead(A0) line lineV) or (analogRead(A2) line lineV)) and (analogRead(A4) line lineV)) and (analogRead(A3) line lineV) and (analogRead(backup) > backupLight) and (analogRead(backup2) > backupLight2) and  // front right and rear left line
        (digitalRead(seven) == HIGH)) {
      goFwd();
    }
    ...
    /*
        if (((digitalRead(three) == LOW) or
             (digitalRead(four) == LOW) or
             (digitalRead(five) == LOW)) and
            ((digitalRead(eight) == LOW) or             // left side candle and right side candle
             (digitalRead(nine) == LOW) or
             (digitalRead(ten) == LOW))) {
          goFwd();
        }
        ...
        // front candle and other
        if (((digitalRead(three) == LOW) or
             (digitalRead(four) == LOW) or
             (digitalRead(five) == LOW) or              // front candle and other
             (digitalRead(eight) == LOW) or
             (digitalRead(nine) == LOW) or
             (digitalRead(ten) == LOW)) and
            (digitalRead(seven) == LOW)) {
          goFwd();
        }
    */
    //..............................................................................................
    ...
    //..............................................................................................
    /*
      if (((analogRead(A5) line lineV) or
         (analogRead(A0) line lineV) or
         (analogRead(A1) line lineV) or
         (analogRead(A2) line lineV))
        and (digitalRead(three) == LOW) or (digitalRead(four) == LOW) or (digitalRead(five) == LOW)) {
      for ( int i = 0; i < 30 ; i ++) {
        turnL();
      ...
      if (((analogRead(A5) line lineV) or
         ...
         (analogRead(A1) line lineV) or
         (analogRead(A2) line lineV))
        and (digitalRead(eight) == LOW) or (digitalRead(nine) == LOW) or (digitalRead(ten) == LOW)) {
      for ( int i = 0; i < 30 ; i ++) {
        turnR();
